...
function SelectDate(obj,strFormat,x,y)
{
    ...
    var date = new Date();
    var by = 2010;//date.getFullYear()-50;  //最小值 → 50 年前
    var ey = 2030//date.getFullYear()+50;  //最大值 → 50 年后
...
function Calendar(beginYear, endYear, lang, dateFormatStyle) {
  ...
  "cur_bg"        : "#66CC99",  //当日日期单元格背影色
  "sel_bg"        : "#FFC2C2",  //已被选择的日期单元格背影色 2006-12-03 寒羽枫添加  
  "sun_word"      : "#F48686",  //星期天文字颜色  
  "sat_word"      : "#40C0F0",  //星期六文字颜色  
  "td_word_light" : "#333333",  //单元格文字颜色  
  "td_word_dark"  : "#CCCCCC",  //单元格文字暗色  
  "td_bg_out"     : "#EFEFEF",  //单元格背影色
  "td_bg_over"    : "#B5E202",  //单元格背影色
...
{
	var str = '<div id="calendarPanel" style="display: none;z-index:9999; background-color: #FFFFFF;border: 1px solid #CCCCCC;width:175px;font-size:12px;"></div>';
	if(document.all)
	{
